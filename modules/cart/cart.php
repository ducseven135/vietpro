...
?>
        ...
        <form method="post">
            ...
            ?>
                <div class="cart-item row">
                    ...
                    <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo number_format($total_price) . " VND"; ?></b><a href="modules/cart/cart_del.php?prd_id=<?php echo $row['prd_id']; ?>">Xóa</a></div>
                </div>
            <?php
            }
            ?>
            <div class="row">
                ...
                <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo number_format($total_price_all) . " VND"; ?></b></div>
            </div>
        </form>
    ...
    <!--	Customer Info	-->
    <?php
    if (isset($_POST['name']) and isset($_POST['phone']) and isset($_POST['mail']) and isset($_POST['add'])) {
        $name = $_POST['name'];
        $phone = $_POST['phone'];
        $email = $_POST['mail'];
        $add = $_POST['add'];
